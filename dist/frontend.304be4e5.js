...
},{"process":18}],3:[function(require,module,exports) {
var $ = require('./jquery');
...
$().ready(function () {
    ...
    $('#login form #connect').click(function () {
        var jGroupID = $('#login #groupID');
        var jNickname = $('#login #nickname');

        var groupID = jGroupID.val();
...
},{"./jquery":17}],23:[function(require,module,exports) {
...
//# sourceMappingURL=/frontend.304be4e5.map